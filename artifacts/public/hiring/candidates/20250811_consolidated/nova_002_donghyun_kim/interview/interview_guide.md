# Interview Guide: Donghyun Kim

## Pre-Interview Preparation (15 minutes)
- [ ] Review candidate's screening report and take-home assignment
- [ ] Prepare technical questions based on their Java, Spring Boot, JPA background
...
Based on candidate's Java, Spring Boot, JPA background:
