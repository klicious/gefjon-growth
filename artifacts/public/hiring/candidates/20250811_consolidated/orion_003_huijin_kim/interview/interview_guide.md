# Interview Guide: Huijin Kim

## Pre-Interview Preparation (15 minutes)
- [ ] Review candidate's screening report and take-home assignment
- [ ] Prepare technical questions based on their Java, Spring, MyBatis background
...
Based on candidate's Java, Spring, MyBatis background:
