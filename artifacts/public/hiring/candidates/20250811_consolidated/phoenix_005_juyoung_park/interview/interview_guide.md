# Interview Guide: Juyoung Park

## Pre-Interview Preparation (15 minutes)
- [ ] Review candidate's screening report and take-home assignment
- [ ] Prepare technical questions based on their Java, Kotlin, Python background
...
Based on candidate's Java, Kotlin, Python background:
